...
(function() {
  ...
  function processInput(text) {
    ...
    if      (t.match(/בקשה|קריאה|תקלה|תחזוקה|ציוד|פנייה/)) flowReq();
      ...
      respond(
        'בחרו מהאפשרויות:',
        `שלום! אני הסייען האישי שלכם בפורטל הארגוני. אני מערכת הדגמה, ולא סייען בינה מלאכותית אמיתי. אני יכול להציג לכם אפשרויות מובנות מראש. בחרו אחת מהאפשרויות הבאות.`,
        600
      );
      appendStarters();
    }
